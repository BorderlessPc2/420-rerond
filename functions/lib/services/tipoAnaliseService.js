...
const REQ_PAC_EXEC = [
    {
        ...
        descricao: "Completude das disciplinas do executivo enviadas (planta, drenagem, terraplenagem, pavimentação, etc. conforme anexos).",
        categoria: "DOCUMENTAL",
    },
    {
...
exports.TIPOS_ANALISE_SEED = [
    {
        ...
        promptOrientacao: "ISOLAMENTO OBRIGATÓRIO: use SOMENTE requisitos com prefixo OCUP_. NÃO aplique ACESSO_*, PAC_*, POC_* ou PPU_*.",
        ativo: true,
    },
    {
        id: "poc",
        ...
        requisitos: REQ_POC,
        promptOrientacao: "ISOLAMENTO POC: use somente POC_*. Não use checklist genérico de outro domínio nem PPU/PAC/acesso.",
        ativo: true,
    },
    {
        id: "acesso",
        ...
        promptOrientacao: "ISOLAMENTO OBRIGATÓRIO: use SOMENTE ACESSO_*. NÃO aplique OCUP_*, PAC_*, POC_* ou PPU_*.",
        ativo: true,
    },
    {
        id: "pac",
        ...
        requisitos: REQ_PAC,
        promptOrientacao: "ISOLAMENTO: use SOMENTE PAC_*. Se a fase for viabilidade ou executivo, prefira pac-viabilidade / pac-executivo.",
        ativo: true,
    },
    {
        id: "pac-viabilidade",
        ...
        promptOrientacao: "FASE VIABILIDADE: use somente PACV_*. Não exija disciplinas de executivo se não foram anexadas.",
        ativo: true,
    },
    {
        id: "pac-executivo",
        ...
        promptOrientacao: "FASE EXECUTIVO: use somente PACE_*. Avalie disciplinas presentes nos anexos; não marque ausente o que não foi enviado.",
        ativo: true,
    },
    {
        id: "ppu",
        ...
        requisitos: REQ_PPU,
        promptOrientacao: "ISOLAMENTO PPU: use somente PPU_*. PROIBIDO checklist genérico de ocupação em faixa.",
        ativo: true,
    },
    {
        id: "outro",
        ...
        documentosSugeridos: [],
        requisitos: [],
        promptOrientacao: "Tipo Outro: use apenas normas/requisitos informados nesta solicitação. NÃO importe checklist de outro domínio.",
        ativo: true,
    },
];
const cache = new Map();
function parseTipo(id, raw) {
    const seed = exports.TIPOS_ANALISE_SEED.find((item) => item.id === id);
...
async function getTipoAnaliseFromFirestore(tipoAnaliseId) {
    ...
    const seed = exports.TIPOS_ANALISE_SEED.find((item) => item.id === id) ?? null;
    cache.set(id, seed);
    return seed;
}
